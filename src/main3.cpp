...
cv::Point3f GetPointInWorld(cv::Point2f pointInImage1, PNPSolver& p4psolver1, cv::Point2f pointInImage2, PNPSolver& p4psolver2)
{
	...
	cout << "point2find1_CF: " << point2find1_CF <<endl;
	...
	//test
	cv::Mat pointc = (cv::Mat_<double>(3,1)<<point2find1_CF.x, point2find1_CF.y, point2find1_CF.z);
	cout << pointc << endl;
	cv::Mat pointt = pointc-p4psolver1.TransM;
	cout<< "TransM: " << p4psolver1.TransM << endl;
	cout<< "rotaM: " << p4psolver1.RoteM << endl;
	cout << "pointt:" << pointt << endl;
	cv::Mat testP = (cv::Mat_<double>(3,3)<<0.02252395188351874, 0.9995475455597602, 0.0199342859668511, 0.5651313316112367, 0.003718329403443965, -0.8249925769713069, -0.8246934276583385, 0.02984758268112758, -0.5647918839583603);

	cout << "testP:" << testP.t()*pointt << endl;
